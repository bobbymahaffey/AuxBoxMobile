...
public class FailedLoginTest {
    ...
    public void failedLoginTest() {
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.email), withText("test"),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("test@test.com"));
        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.password),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText6.perform(replaceText("test050"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textView2), withText("Please sign in"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
                                1),
                        isDisplayed()));
        textView.check(matches(withText("Please sign in")));
    }
